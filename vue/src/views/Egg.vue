<template>
  <div class="egg">
    <i class="fas fa-egg fa-10x" id="egg"></i>
  </div>
</template>
    ...
    $("#egg")
      .on("mousedown", function () {
        ...
        if (clicks > 42) {
          ...
          $(this)
            .toggleClass("fas far")
            .toggleClass("fa-egg fa-grin-beam-sweat");
        } else if (clicks > 13) {
      ...
      .on("mouseup", function () {
        ...
        $(this)
          .removeClass("fa-smile-wink")
          .removeClass("fa-smile")
          .removeClass("fa-grin");
        $(this)
          .removeClass("fa-grin-beam")
          .removeClass("fa-grin-beam-sweat")
          .removeClass("fa-meh");
        $(this)
          .removeClass("fa-meh-blank")
          .removeClass("fa-flushed")
          .removeClass("fa-frown");
        $(this)
          .removeClass("fa-frown-open")
          .removeClass("fa-angry")
          .removeClass("fa-dizzy");
